		...
		<div className="bg-dark text-white ">
			<div className="container p-5 ">
				...
				<div className="d-flex gap-3 align-items-center justify-content-center mt-5">
					<a href="https://www.instagram.com/thesnuslifeltd/" target="_blank">
						<FaInstagram style={{ color: "white" }} className="fs-5 mr-2" />
					</a>
					<a href="https://www.facebook.com/people/The-Snus-Life/100086120607791/" target="_blank">
						<FaFacebook style={{ color: "white" }} className="fs-5 mr-2" />
					</a>
					<a href="https://www.tiktok.com/@thesnuslife.co.uk" target="_blank">
